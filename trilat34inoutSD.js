...
// trilat234inoutSD choose from these points (using points for all triples and quadruples of signals) trilateration
// point with minimal sumDevAll (with minimal sum of deviations from all 3 or 4 trilateration circles) inside
// the room tested; if there is no point within the room tested then returns point outside the room with
// minimal sumDevAll;
...
function trilat34inoutSD (points, target) {
  if (points.length < 3) {
    return undefined
  }
...
module.exports = trilat34inoutSD
