...
test('should find the solution inside the room for 4 points if this solution exists', () => {
...
test('should return point outside the room if the solution inside the room doesn`t exists', () => {
  let signals = makeSignals(ROOM, [1.20, 20.45, 40.01, 0]).slice(0, 3)
...
test('should find the solution inside the room for 3 points if this solution exists', () => {
