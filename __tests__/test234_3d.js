...
const trilatTest = require('../trilat234')
...
test('should work for 2 points', () => {
  ...
  let pos = trilatTest(signals, {z: 1.3})
  expect(pos.z).toBe(1.3) // z should match
})
...
test('should place first point near center when all distances are equal 1.0', () => {
  ...
  expect(getDistance(pos, ROOM_CENTER)).toBeLessThan(2.0)
})
...
test('should place first point near center when all distances are equal 2.0', () => {
  ...
  expect(pos.x).toBeGreaterThan(30)
  expect(pos.y).toBeGreaterThan(50)
  expect(getDistance(pos, ROOM_CENTER)).toBeLessThan(1.5)
})

test('should find the solution in the room for 4 points if this solution exists', () => {
...
test('should return "undefined" if the solution inside the room tested doesn`t exists', () => {
...
test('should find the solution in the room for 3 points if this solution exists', () => {
...
test('should find the solution in the room for 2 points if this solution exists', () => {
