// function trilat234outSD (points, target) takes:
...
// function trilat234outSD refers to the function trilateration which calculates all trilateration points and
// function trilat234outSD choose from these points one trilateration point (green, yellow or blue point) with minimal
// sumDevAll(minimal deviation from all 2, 3 or 4 signals) and is located within the room tested;
// if there is no the point within the room tested than returns points outside the room with minimal sumDev
// if there is no such point then returns underfined
// function trilat234outSD returns:
...
function trilat234outSD (points, target) {
